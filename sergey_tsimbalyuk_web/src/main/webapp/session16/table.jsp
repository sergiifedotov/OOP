...
<table width="100%">
    <tr>
        <td align="center">Раздел 1</td>
        <td align="center">Раздел 2</td>
        <td align="center">Раздел 3</td>
    </tr>
    <tr>
        <td align="center" colspan="3"><img src="https://pbs.twimg.com/media/B-wded8VEAAgJpW.jpg:large"></td>
        <%--<td>row 2 cell 2</td>--%>
        <%--<td>row 2 cell 3</td>--%>
    </tr>
    <tr>
        <td>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.
        ...
        <td colspan="2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.
    ...
    <tr>
        <td align="center" colspan="3">(c) Sergey Tsimbalyuk, 2015</td>
        <%--<td>row 4 cell 2</td>--%>
        <%--<td>row 4 cell 3</td>--%>
    </tr>
</table>
