 ...
 * - String setTextFromConsole() - добавляет текст с консоли
 * в строку и возвращает строку
 * - String setTextFromFile(String fileName) - добавляет текст
 * из указанного по имени файла в строку и возвращает строку
 * - String generateRandomText(int textLength) - генерирует
 * случайный текст по указанной длине
 * - Set<String> getWordsByFrequency(int frequency) - возвращает
 * множество слов, которые встречаются указанное количество раз
 ...
 * - void printAcs() - вывести все слова + частота по возрастанию
 * частоты
 * - void printDesc() - вывести все слова + частота по убыванию
 * частоты
 *
