 ...
 * 6) Получить имена сотрудников с зарплатой и кодом руководителя, для которых этот код принимает одно из значений 114, 121, 205
 * 7) Получить имена сотрудников, у которых в имени вторая буква = m, а предпоследняя буква = t
...
//    3.
//    SELECT first_name, (salary*0.1) as TAX from EMPLOYEES;
//    4.
//    SELECT first_name, last_name, hire_date FROM employees WHERE hire_date > '01.01.1982';";
//    5.
//    SELECT * FROM employees WHERE commission_pct > 0.5
//    6.
//    select first_name, last_name, salary, manager_id from employees where manager_id = 114 or MANAGER_ID=121 or MANAGER_ID = 205;
//    7.
